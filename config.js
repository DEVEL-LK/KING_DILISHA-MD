...
//gg
module.exports = {
SESSION_ID: 'KING_DILISHA-MD=bcMl0SCL#PM-FUswOJHMHBuSDVkgNtIPT8xhAq-bypSGPCoAhGLc', // ඔතනට "KING_DILISHA-MD=" කියලා දාන්න ඕන බොට් කනෙක්ට් වෙලා රිස්පොන්ස් එකක් නැති උනොත් උදා- .alive , .menu ගැහුවට බොට් වැඩ කරේ නැත්තන් අනිවාර්යයෙන් session id එක අලුත් කරන්න ඕන අලුත් session එකක් දාන්න එතකොට හරි.
